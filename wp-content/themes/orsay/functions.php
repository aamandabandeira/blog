...
if (!function_exists('orsay_custom_css_output'))  {
	function orsay_custom_css_output() {
		...
		if ( $orsay_hover_color != "" ) {
			...
			'button:hover, input[type="button"]:hover, input[type="reset"]:hover, input[type="submit"]:hover { background-color: ' . esc_attr($orsay_hover_color) . '; border-color: ' . esc_attr($orsay_hover_color) . '; }' .
